...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = './trj_webgl.data';
      var REMOTE_PACKAGE_BASE = 'trj_webgl.data';
...
Module['FS_createPath']('/res', 'fonts', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_./trj_webgl.data');

      };
      Module['addRunDependency']('datafile_./trj_webgl.data');
   ...
   loadPackage({"files": [{"filename": "/res/fonts/default.ttf", "start": 0, "end": 86908, "audio": 0}], "remote_package_size": 86908, "package_uuid": "e3655d8c-a5b0-483a-84dd-986470df259a"});
...
var STACK_BASE = 5536704,
    STACKTOP = STACK_BASE,
    STACK_MAX = 293824,
    DYNAMIC_BASE = 5536704;
...
var wasmBinaryFile = 'trj_webgl.wasm';
