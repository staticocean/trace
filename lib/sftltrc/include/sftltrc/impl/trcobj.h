...
static
t_s8 __trcobj_init__ (void *__obj__, void *__attr__)
{
	return 0x00;
}
...
static
t_s8 __trcobj_free__ (void *__obj__)
{
	return 0x00;
}
...
static
t_s8 __trcobj_save__ (void *__obj__, s_trcspl *spl, t_u8 **v_file)
{
	return 0x00;
}
...
static
t_s8 __trcobj_load__ (void *__obj__, s_trcspl *spl, t_u8 **v_file)
{
	return 0x00;
}
...
t_s8 trcpack_init (s_trcobj *obj, s_trcobj_init attr)
{
	obj->traj_sz = 0x00;
	obj->ctrl_sz = 0x00;
	obj->data_sz = 0x00;
