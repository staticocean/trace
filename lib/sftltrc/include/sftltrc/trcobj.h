...
static
s8_t __trcobj_save__ (void *__obj__, s_trcspl *spl, u8_t **v_file)
{
	return 0x00;
}
...
static
s8_t __trcobj_load__ (void *__obj__, s_trcspl *spl, u8_t **v_file)
{
	return 0x00;
}
...
s8_t trcpack_init (s_trcobj *obj, s_trcobj_init attr)
{
	obj->traj_sz = 0x00;
	obj->ctrl_sz = 0x00;
	obj->data_sz = 0x00;
