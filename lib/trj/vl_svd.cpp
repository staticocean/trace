...
void vl_svd(float *mat, float *u, float *s, float *v)
{
	svd(
			mat[0], mat[1], mat[2],
			mat[3], mat[4], mat[5],
			...
			reinterpret_cast<float &>(u[0]), reinterpret_cast<float &>(u[1]), reinterpret_cast<float &>(u[2]),
			reinterpret_cast<float &>(u[3]), reinterpret_cast<float &>(u[4]), reinterpret_cast<float &>(u[5]),
			reinterpret_cast<float &>(u[6]), reinterpret_cast<float &>(u[7]), reinterpret_cast<float &>(u[8]),
			
			reinterpret_cast<float &>(s[0]), reinterpret_cast<float &>(s[1]), reinterpret_cast<float &>(s[2]),
			reinterpret_cast<float &>(s[3]), reinterpret_cast<float &>(s[4]), reinterpret_cast<float &>(s[5]),
			reinterpret_cast<float &>(s[6]), reinterpret_cast<float &>(s[7]), reinterpret_cast<float &>(s[8]),
			
			reinterpret_cast<float &>(v[0]), reinterpret_cast<float &>(v[1]), reinterpret_cast<float &>(v[2]),
			reinterpret_cast<float &>(v[3]), reinterpret_cast<float &>(v[4]), reinterpret_cast<float &>(v[5]),
			reinterpret_cast<float &>(v[6]), reinterpret_cast<float &>(v[7]), reinterpret_cast<float &>(v[8])
	);
