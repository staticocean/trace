...
/*! \brief create a new MAT file
  ...
  */
TinyMATWriterFile* TinyMATWriter_open(const char* filename, const char* description=NULL, size_t bufSize=1024*100);
...
/*! \brief write a 1-dimensional std::list<double> into a MAT-file as a 1D matrix
  ...
  */
void TinyMATWriter_writeDoubleList(TinyMATWriterFile* mat, const char* name, const std::list<double>& data, bool columnVector=false);
...
/*! \brief write a 1-dimensional std::vector<double> into a MAT-file as a 1D matrix
  ...
  */
void TinyMATWriter_writeDoubleVector(TinyMATWriterFile* mat, const char* name, const std::vector<double>& data, bool columnVector=false);
...
*/
inline void TinyMATWriter_startCellVectorAsCol(TinyMATWriterFile *mat, const char *name, int32_t nitems) {
...
*/
inline void TinyMATWriter_startCellVectorAsRow(TinyMATWriterFile *mat, const char *name, int32_t nitems) {
...
*/
inline void TinyMATWriter_startCellMatrix2D(TinyMATWriterFile *mat, const char *name, int32_t cols, int32_t rows) {
  int32_t dims[2] = { rows,cols };
  TinyMATWriter_startCellArray(mat, name, dims, 2);
}
...
inline void TinyMATWriter_writeCVVecAsRow(TinyMATWriterFile* mat, const char* name, const cv::Vec<T, cn>& vec) {
...
*/
template <typename T, int cn>
inline void TinyMATWriter_writeCVVecAsColumn(TinyMATWriterFile* mat, const char* name, const cv::Vec<T, cn>& vec) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVPointAsRow(TinyMATWriterFile* mat, const char* name, const cv::Point_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVPointAsColumn(TinyMATWriterFile* mat, const char* name, const cv::Point_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVPoint3AsColumn(TinyMATWriterFile* mat, const char* name, const cv::Point3_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVPoint3AsRow(TinyMATWriterFile* mat, const char* name, const cv::Point3_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVScalarAsColumn(TinyMATWriterFile* mat, const char* name, const cv::Scalar_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVScalarAsRow(TinyMATWriterFile* mat, const char* name, const cv::Scalar_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVSizeAsRow(TinyMATWriterFile* mat, const char* name, const cv::Size_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVSizeAsColumn(TinyMATWriterFile* mat, const char* name, const cv::Size_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVRectAsRow(TinyMATWriterFile* mat, const char* name, const cv::Rect_<T>& p) {
...
*/
template <typename T>
inline void TinyMATWriter_writeCVRectAsColumn(TinyMATWriterFile* mat, const char* name, const cv::Rect_<T>& p) {
...
*/
inline void TinyMATWriter_writeCVRangeAsRow(TinyMATWriterFile* mat, const char* name, const cv::Range& p) {
...
*/
inline void TinyMATWriter_writeCVRangeAsColumn(TinyMATWriterFile* mat, const char* name, const cv::Range& p) {
