...
struct Picoc_Struct {
    ...
    PICOC_IOFILE *CStdOut;
//    PICOC_IOFILE CStdOutBase;
...
extern void PrintCh(char OutCh, PICOC_IOFILE *Stream);
extern void PrintSimpleInt(long Num, PICOC_IOFILE *Stream);
extern void PrintInt(long Num, int FieldWidth, int ZeroPad, int LeftJustify,
					 PICOC_IOFILE *Stream);
extern void PrintStr(const char *Str, PICOC_IOFILE *Stream);
extern void PrintFP(double Num, PICOC_IOFILE *Stream);
extern void PrintType(struct ValueType *Typ, PICOC_IOFILE *Stream);
...
extern void PlatformPrintf(PICOC_IOFILE *Stream, const char *Format, ...);
extern void PlatformVPrintf(PICOC_IOFILE *Stream, const char *Format, va_list Args);
