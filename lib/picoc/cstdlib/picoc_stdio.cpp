    ...
    struct Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = fsetpos((FILE*) Param[0]->Val->Pointer,
										(const fpos_t*) Param[1]->Val->Pointer);
}
...
void StdioFputs(struct ParseState *Parser, struct Value *ReturnValue,
    struct Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = fputs((const char*) Param[0]->Val->Pointer,
									  (FILE*) Param[1]->Val->Pointer);
}
    ...
    struct Value **Param, int NumArgs)
{
    ...
    ReturnValue->Val->Integer = StdioBasePrintf(Parser, NULL,
												(char*) Param[0]->Val->Pointer, -1,
												(char*) Param[1]->Val->Pointer, &PrintfArgs);
}
    ...
    struct Value **Param, int NumArgs)
{
    ...
    ReturnValue->Val->Integer = StdioBasePrintf(Parser, NULL,
												(char*) Param[0]->Val->Pointer, Param[1]->Val->Integer,
												(char*) Param[2]->Val->Pointer,
        &PrintfArgs);
}
    ...
    struct Value **Param, int NumArgs)
{
    ...
    ReturnValue->Val->Integer = StdioBaseScanf(Parser, NULL,
											   (char*) Param[0]->Val->Pointer,
											   (char*) Param[1]->Val->Pointer, &ScanfArgs);
}
